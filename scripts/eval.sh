...
--model_args pretrained=lmms-lab/llava-onevision-qwen2-7b-ov,conv_template=qwen_1_5,model_name=llava_qwen,max_frames_num=32,attn_implementation=flash_attention_2,fastvid_retention_ratio=${fastvid_retention_ratio},fastvid_DySeg_c=${fastvid_DySeg_c},fastvid_DySeg_tau=${fastvid_DySeg_tau},fastvid_STPrune_d=${fastvid_STPrune_d},fastvid_DTM_p=${fastvid_DTM_p},fastvid_DTM_alpha=${fastvid_DTM_alpha} \
--tasks videomme \
--batch_size 1 \
--log_samples \
