...
class Qwen2Model(Qwen2PreTrainedModel):
    ...
    def __init__(self, config: Qwen2Config):
        ...
        self.fastvid_DTM_alpha = config.fastvid_DTM_alpha
        eval_logger.info(f'attn_implementation={self._attn_implementation} fastvid_retention_ratio={self.fastvid_retention_ratio} fastvid_DySeg_c={self.fastvid_DySeg_c} fastvid_DySeg_tau={self.fastvid_DySeg_tau} fastvid_STPrune_d={self.fastvid_STPrune_d} fastvid_DTM_p={self.fastvid_DTM_p}  fastvid_DTM_alpha={self.fastvid_DTM_alpha}')
